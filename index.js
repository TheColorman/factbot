...
const images = fs_1.default.readdirSync('./images');
const bugs = fs_1.default.readdirSync('./images/bug');
client.once('ready', () => {
    console.log('Ready!');
});
const botResponses = [
...
const createOutput = (message, inputMessage) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (inputMessage) {
        const allUsers = yield ((_a = inputMessage.guild) === null || _a === void 0 ? void 0 : _a.members.fetch());
        const nonbots = allUsers === null || allUsers === void 0 ? void 0 : allUsers.filter(u => !u.user.bot);
        const randomUser = nonbots === null || nonbots === void 0 ? void 0 : nonbots.random();
...
client.on('messageCreate', (message) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    if (!message.client.user)
        return;
    if (message.author.equals(message.client.user))
        return;
    function sendMessage(sendFunction) {
    ...
    if (message.author.bot && random < 0.20) {
        sendMessage(() => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return message.reply(yield createOutput(botResponses[Math.floor(Math.random() * botResponses.length)])); }));
        return;
    }
    ...
    if (previousUser.equals(message.client.user)) {
        if (insults.some(insult => message.content.toLowerCase().includes(insult))) {
            sendMessage(() => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return message.reply(yield createOutput(insultReplies[Math.floor(Math.random() * insultReplies.length)])); }));
            return;
        }
    }
    if (message.mentions.users.has(message.client.user.id)) {
        sendMessage(() => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return message.reply(yield createOutput(general[Math.floor(Math.random() * general.length)], message)); }));
        return;
    }
    if (message.content.includes("cunny") && random > 0.50) {
        const image = images[Math.floor(Math.random() * images.length)];
        const file = new discord_js_1.MessageAttachment(path_1.default.resolve(__dirname + '\\images\\' + image));
    ...
    if (message.content.includes("bug") && random > 0.80) {
        ...
        const file = new discord_js_1.MessageAttachment(path_1.default.resolve(__dirname + '\\images\\bug\\' + bug));
        sendMessage(() => message.reply({ files: [file] }));
        return;
    }
